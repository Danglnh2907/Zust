...
<%@ page import="dto.JoinGroupRequestDTO" %>
...
<head>
    ...
    <style>
        ...
        .join-requests-section { margin-top: 20px; }
        .join-request-list { display: flex; flex-direction: column; gap: 15px; }
        .join-request-item {
...
<div class="app-layout">
    ...
    <main class="main-content">
        ...
        <div class="group-tabs">
            <a href="${pageContext.request.contextPath}/group?id=<%= group.getId() %>" class="tab-item <%= request.getParameter("tag") == null || "discussion".equals(request.getParameter("tag")) ? "active" : "" %>">Discussion</a>
            <a href="${pageContext.request.contextPath}/group?id=<%= group.getId() %>&tag=members" class="tab-item <%= "members".equals(request.getParameter("tag")) ? "active" : "" %>">Members</a>
            <% if (interactStatus == InteractGroupDTO.InteractStatus.MANAGER || interactStatus == InteractGroupDTO.InteractStatus.LEADER) { %>
            <a href="${pageContext.request.contextPath}/group?id=<%= group.getId() %>&tag=requests" class="tab-item <%= "requests".equals(request.getParameter("tag")) ? "active" : "" %>">Joining Request</a>
            <a href="${pageContext.request.contextPath}/group?id=<%= group.getId() %>&tag=pending" class="tab-item <%= "pending".equals(request.getParameter("tag")) ? "active" : "" %>">Pending Post</a>
            <a href="${pageContext.request.contextPath}/group?id=<%= group.getId() %>&tag=feedback" class="tab-item <%= "feedback".equals(request.getParameter("tag")) ? "active" : "" %>">View Feedback</a>
            <% } %>
