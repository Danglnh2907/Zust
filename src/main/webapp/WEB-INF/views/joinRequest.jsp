                ...
                <section class="group-card">
                    ...
                    <div class="group-info-body">
                        ...
                        <nav class="group-tabs">
                            ...
                            <a href="${pageContext.request.contextPath}/joinRequest?groupId=${groupId}" class="active">Joining Request</a>                            <a href="${pageContext.request.contextPath}/approvePost?groupId=${groupId}">Pending Posts</a>
