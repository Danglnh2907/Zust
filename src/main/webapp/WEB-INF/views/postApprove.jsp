    ...
    <main class="main-content">
        <c:choose>
            <c:when test="${groupInfo != null && groupId != null}">
                ...
                <section class="post-card" id="post-approval">
                        ...
                        <c:otherwise>
                            <div class="pending-posts-container">
                                <c:forEach var="dto" items="${posts}">
                                    ...
                                    <%-- Thay thế thẻ div.pending-post-card cũ bằng đoạn code này --%>
                                    <div class="pending-post-card">
                                        <div class="post-header">
                                            <div class="post-author">
                                                ...
                                                <%-- KHU VỰC NÚT BẤM ĐÃ ĐƯỢC DI CHUYỂN LÊN ĐÂY VÀ CHỈNH SỬA --%>
                                            <div class="post-actions-icon">
                                                <form action="${pageContext.request.contextPath}/approvePost" method="post" style="display:inline;">
                                                    <input type="hidden" name="postId" value="${dto.post.id}">
