...
<html>
    <head>
        ...
        <style>
            ...
            .post-approval-container .post-card {
            ...
            <main class="main-content">
                ...
                <div class="group-tabs">
                    ...
                    <a href="${pageContext.request.contextPath}/group?id=<%= group.getId() %>&tag=pending"
                       class="tab-item active">Pending Post</a>
                    ...
                    <div class="feed">
                        <%
                            if (pendingPosts != null && !pendingPosts.isEmpty()) {
                                for (RespPostDTO pending : pendingPosts) {
                        %>
                        <div class="post-approval-container">
                            <%=pending%>
                            <div class="approval-actions">
                                <form method="POST" style="display:inline;">
                                    <input type="hidden" name="action" value="accept-post">
                                    <input type="hidden" name="postId" value="<%= pending.getPostId() %>">
                                    <input type="hidden" name="groupId" value="<%= group.getId() %>">
                                    <button type="submit" class="btn btn-approve">Approve</button>
                                </form>
                                <form method="POST" style="display:inline;">
                                    <input type="hidden" name="action" value="dismiss-post">
                                    <input type="hidden" name="postId" value="<%= pending.getPostId() %>">
                                    <input type="hidden" name="groupId" value="<%= group.getId() %>">
