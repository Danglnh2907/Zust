            ...
            <main class="main-content">
                ...
                <div class="group-tabs">
                    ...
                    <a href="${pageContext.request.contextPath}/group?id=<%= group.getId() %>&tag=report"
                       class="tab-item active">Report Content</a>
                    <% } %>
                </div>
                ...
                <div class="post-feed-section">
                    ...
                    <div class="feed">
                        ...
                        <%
                            ...
                            for (GroupReport report : reportPostList) {
                        %>
                        <div class="card report-card mb-3">
                            <div class="card-body">
                                <!-- Reporter Info -->
                                <div class="report-header">
                                    <img src="${pageContext.request.contextPath}/static/images/<%= report.getReporterAvatar() %>"
                                         alt="Reporter Avatar" class="report-avatar">
                                    <div class="report-details">
                                        <h5 class="card-title mb-1">
                                            Reported by:
                                            <a href="${pageContext.request.contextPath}/profile?userId=<%= report.getReporterID() %>">
                                ...
                                <div class="report-actions mt-4">
                                    <form method="POST" action="${pageContext.request.contextPath}/group">
                                        <input type="hidden" name="action" value="accept-report">
                                        <input type="hidden" name="groupId" value="<%= group.getId() %>">
                                        <input type="hidden" name="reportId" value="<%= report.getReportID() %>">
                                        <input type="hidden" name="reportType" value="<%= report.getReportedPost() != null ? "post" : "comment" %>">
                                        <button type="submit" class="btn btn-success">Accept</button>
                                    </form>
                                    <form method="POST" action="${pageContext.request.contextPath}/group" class="ms-2">
                                        <input type="hidden" name="action" value="dismiss-report">
                                        <input type="hidden" name="groupId" value="<%= group.getId() %>">
                                        <input type="hidden" name="reportId" value="<%= report.getReportID() %>">
                                        <input type="hidden" name="reportType" value="<%= report.getReportedPost() != null ? "post" : "comment" %>">
