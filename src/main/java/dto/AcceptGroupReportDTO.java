...
public class AcceptGroupReportDTO {
    ...
    public AcceptGroupReportDTO() {
    }

    // Constructor đầy đủ
    public AcceptGroupReportDTO(int reportId, int reportAccountId, int reportedAccountId, int reportedPostId, String notificationContent) {
